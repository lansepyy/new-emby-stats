...
import { Overview, Content, Users, Devices, History, Login, Notifications, NotificationTemplates, Favorites, Covers } from '@/pages'
        ...
        <>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeTab === 'covers' && <Covers />}
              {activeTab === 'notifications' && <Notifications />}
              {activeTab === 'report' && <NotificationTemplates />}
            </motion.div>
          </AnimatePresence>
        </>
      )}
